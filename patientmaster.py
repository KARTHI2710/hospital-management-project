...
# Form implementation generated from reading ui file 'patientmaster.ui'
#
...
from editpatientregister1 import Ui_editpatientForm
import qrcode
...
class Ui_PatientMasterForm(object):
        ...
        for patient_info in patient_info_all:
            if patient_info:
               ...
               # visit_id, ref_dr, patient_category, patientname, gender, dob, age, mobile, email, date, selected_test,patient_id = patient_info
                uhid,date,title,patientname,dob,age,gender,mobile,email,refdr,selectedtest,accession,id,id1=patient_info
