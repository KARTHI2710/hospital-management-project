    ...
    def populate_refdr_data(self):
        if self.DoctorCode:
            ...
            if refdr_data:
                ...
                self.lineEdit_25.setText(refdr_data[0])  # Assuming the first item is DoctorCode
                self.lineEdit_26.setText(refdr_data[1])   # Assuming the second item is DoctorName
                self.lineEdit_27.setText(refdr_data[2])  # Assuming the third item is Qualification
                self.lineEdit_28.setText(refdr_data[3])   # Assuming the fourth item is Specialisation
                self.lineEdit_29.setText(refdr_data[4])  # Assuming the fifth item is Address
                self.lineEdit_30.setText(refdr_data[5])  # Assuming the sixth item is Mobile
