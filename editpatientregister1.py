    ...
    def populate_patient_data(self):
        if self.patient_uhid:
            ...
            if patient_data:
                ...
                self.comboBox.setCurrentText(patient_data[2])  # Assuming the second item is the title
                ...
                self.lineEdit_30.setText(str(patient_data[5]))
                self.comboBox_2.setCurrentText(patient_data[6])
